...
/* Assignment routing only. The client-health formula used to be a second
   top-level tab in here, which meant Settings had two tabs called "Client
   health" — one editing the real weights, the other showing a formula from
   the retired model-v1 engine. Everything that decides a health score now
   lives under Settings → Client health; see ClientHealthFormula.tsx. */
